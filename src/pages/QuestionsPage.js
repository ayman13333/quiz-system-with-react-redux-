...
export default function QuestionsPage() {
  ...
  function SubmitAnswer() {
    ...
    if (currentChoiceIndex.current == "" || (currentQuestionIndex == questions.length-1)) return;

    dispatch(addAnswer(currentChoiceIndex.current));
  ...
  return (
    <div className="mx-auto my-auto">
      <h3 className="my-3">{questions[currentQuestionIndex].question}</h3>
